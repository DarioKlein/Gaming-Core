    ...
    echo '
      <div class="header-container-jogo">
        ...
        <div class="avaliacao" id="av1">
          ...
          <p><img src="extraAndImg-jogo/star-all.svg" alt="" />8.7</p>
        </div>
  
        <div class="avaliacao" id="av2">
          <h2>Faça sua avaliação</h2>
          <a href=""
            ><img src="extraAndImg-jogo/star-user.svg" alt="" />
            <p>Avaliar</p>
          </a>
        </div>
      ...
      <div class="body-container-jogo">
        <div class="img-principal">
          ...
          <button onclick="favoritar()">
            <img class="fav" id="fav" src="extraAndImg-jogo/add-list.svg" alt="" />
          </button>
        </div>
        <div class="video">
      ...
      <div class="footer-container-jogo">
        ...
        <div class="developer">
          <p>Produzido por: '. $row_div["developer"] .'
        </div>
        ...
        <div class="button">
          <button>
            <img src="extraAndImg-jogo/add.svg" alt="" />
            Adicionar à Lista
          </button>
          <p>32 usuários já avaliaram.</p>
          <p>Adicionado por 21 usuários.</p>
        </div>

        <div class="button2">
          <a href="#jogos-explore">
            Ver <img src="extraAndImg-jogo/add.svg" alt="" /> jogos do gênero
          </a>
        </div>

        <div class="avaliacao" id="av3">
          <h2>Avaliação dos usuários</h2>
          <p id="para"><img src="extraAndImg-jogo/star-all.svg" alt="" />8.7</p>
        </div>
      </div>
     ...
     ';
      ...
      $sql_2 = "SELECT * FROM jogos WHERE genero = '$genero_atual' LIMIT $offset, 4";
      $result = $conn->query($sql_2);
        ...
        if ($result->num_rows > 0) {
          ...
          echo '
            ...
            <img src="extraAndImg-jogo/loading-gif.gif" alt="Carregando..." />
            </div>
          ...
          <div class="cards-side">
            ...
            <a id="lancamentos" href="">
              ...
              <p class="list-icon" id="icon-list">
                <img id="list-img" src="extraAndImg-jogo/list.svg" alt="" />Lançamentos
              </p>
            ...
            <a id="lancamentos2" href="">
              ...
              <p class="list-icon" id="icon-list2">
                <img id="list-img2" src="extraAndImg-jogo/list.svg" alt="" />Destaques
              </p>
            ...
            <a id="lancamentos3" href="">
              ...
              <p class="list-icon" id="icon-list3">
                <img id="list-img3" src="extraAndImg-jogo/list.svg" alt="" />O que jogar?
              </p>
            ...
            <a id="lancamentos4" href="">
              ...
              <p class="list-icon" id="icon-list4">
                <img id="list-img4" src="extraAndImg-jogo/list.svg" alt="" />Top da semana
              </p>
            ...
            <a
              id="last-a"
              href="https://store.steampowered.com/?l=portuguese"
              target="_blank"
            >
