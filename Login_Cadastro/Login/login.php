      ...
      <div class="right-login">
        <div class="card-login">
          ...
          <div class="textfield">
            ...
            <input type="text" name="logar" id="logar" placeholder="Usuário" oninput="verificarCampoPreenchido()" onkeyup="limitarComprimento(this, 20)" />
          </div>
          <div class="textfield">
          ...
          <input type="submit" class="btn-login" value="entrar" name="entrar" id="entrar" disabled />
          <div class="register">
            <div class="esqueci">
